...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('aadil', 'turbo')")
        cursor.execute("INSERT INTO `login` (username, password) VALUES('psg', 'user')")
        cursor.execute("INSERT INTO `login` (username, password) VALUES('shibil', '12345')")
        conn.commit()
